    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class=""><a href="index.html"><i class="fa fa-circle-o"></i> Thống kê</a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class=""><a href="index.html"><i class="fa fa-circle-o"></i> Thông tin</a></li>
          <li class=""><a href="index.html"><i class="fa fa-circle-o"></i> Slide shows</a></li>
        </ul>
      </li>
    </ul>
  </section>
